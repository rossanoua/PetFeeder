...
| 9a | **Lower body chassis** | 3D printed, `chassis_module.scad`. **220×200×160 mm** (Ø80 mechanism; the Ø160 hopper centers at x=−23.5 so it fits 220). C-shape: bowl niche at front (130×160×80 mm), top recess seating the rotary housing (**Ø88**), internal slanted chute redirecting kibble from floor outlet to a front-face exit above the bowl, electronics-bay cavity carved from the back. | 1 | 🧪 to model further (next: motor mount, panel cutouts, load-cell mount) |
