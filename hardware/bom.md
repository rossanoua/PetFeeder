...
| 8b | **Bulk hopper — funnel** | 3D printed, parametric — `bulk_hopper_module.scad part="funnel"`. Ø160 round top × **140 mm** tall, narrows to **rect bottom** matching the cap inlet hole (22×28 rounded). Anti-bridge cone (4 ribs) inside. **No spout walls** (collar-mount, sits ON the cap). | 1 | 🧪 to validate |
